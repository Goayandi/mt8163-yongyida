...
if [ $ISDAILY == daily ]; then
    VersionNumber="QY50B_V3R001"_`date +%Y%m%d%H%M`
else
    VersionNumber="QY50B_V3R001"
fi
echo $VersionNumber
...
#scp -r "$VersionNumber" peishengguo@172.16.1.246:/home/peishengguo/code/Y50D_VERSION

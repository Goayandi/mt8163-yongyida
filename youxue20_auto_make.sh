...
#客制化配置路径
CUSTOMIZATION_PATH=yongyida/customer/youxue/y20c
...
if [ $ISDAILY == daily ]; then
    VersionNumber="YOS_YX_V1R002"_`date +%Y%m%d%H%M`
else
    VersionNumber="YOS_YX_V1R002"
fi
echo $VersionNumber
...
scp -r "$VersionNumber" sw_release@172.16.1.242:/home/sw_release/test_rom/y20c/youxue
